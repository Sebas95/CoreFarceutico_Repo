...
app.controller("editRecetasController", ["$scope", "$location", "$routeParams", "clientService", "JsonResource", "editRecetasResource",


function ($scope, $location, $routeParams, clientService, JsonResource, editRecetasResource) {
